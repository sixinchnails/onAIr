...
const KAKAO_OAUTH_URL = `https://j9b302.p.ssafy.io:8080/oauth2/authorization/kakao`;
...
const NAVER_OAUTH_URL = `https://j9b302.p.ssafy.io:8080/oauth2/authorization/naver`;
